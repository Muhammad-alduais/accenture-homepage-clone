...
export const translations = {
  ar: {
    ...
    'about.mission.metrics.days': 'أيام',
    'about.mission.metrics.daysDesc': 'إلى القيمة',
    'about.mission.metrics.process': 'كفاءة',
    'about.mission.metrics.processDesc': 'العملية',
    'about.mission.metrics.user': 'تبني',
    'about.mission.metrics.userDesc': 'المستخدم',
  ...
  en: {
    ...
    'about.mission.metrics.days': 'Days',
    'about.mission.metrics.daysDesc': 'to Value',
    'about.mission.metrics.process': 'Process',
    'about.mission.metrics.processDesc': 'Efficiency',
    'about.mission.metrics.user': 'User',
    'about.mission.metrics.userDesc': 'Adoption',
