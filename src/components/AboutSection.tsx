    ...
    <section className="py-24 bg-white dark:bg-black">
      <div className="container mx-auto px-4">
        ...
        >
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-brand-primary">{t('about.mission.metrics.days')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-300">{t('about.mission.metrics.daysDesc')}</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-brand-primary">{t('about.mission.metrics.process')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-300">{t('about.mission.metrics.processDesc')}</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-brand-primary">{t('about.mission.metrics.user')}</div>
          ...
          {/* Regional Emphasis */}
          <motion.div 
            className="bg-gradient-to-r from-brand-primary to-brand-accent rounded-2xl p-12 text-center text-white"
            variants={itemVariants}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-blue-100">{t('about.regional.understanding.description')}</p>
              </div>
              <div>
                <div className="text-3xl mb-3">🗣️</div>
                <h4 className="font-bold mb-2">{t('about.regional.bilingual.title')}</h4>
                <p className="text-blue-100">{t('about.regional.bilingual.description')}</p>
              </div>
              <div>
                <div className="text-3xl mb-3">⭐</div>
                <h4 className="font-bold mb-2">{t('about.regional.standards.title')}</h4>
                <p className="text-blue-100">{t('about.regional.standards.description')}</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
