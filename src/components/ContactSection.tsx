        ...
        >
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Connect with our ERP experts and discover how MovinWare can accelerate your digital transformation journey.
            </motion.p>
          </div>
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8">
                  Ready to start your transformation journey? Our ERP experts are here to help you every step of the way.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">hello@movinware.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">+971 4 XXX XXXX</div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <motion.button 
                    className="w-full border border-purple-600 text-purple-600 dark:text-purple-400 hover:bg-purple-600 hover:text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="font-semibold text-green-700 dark:text-green-300">WhatsApp Support</span>
                </div>
