...
export default function ContactSection() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.inquiryType) {
      newErrors.inquiryType = t('contact.form.errors.inquiryTypeRequired')
    }
  ...
  return (
    <section className="py-24 bg-white dark:bg-black" aria-labelledby="contact-heading">
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                    {errors.name && (
                      <p id="name-error" className={`mt-1 text-sm text-red-600 dark:text-red-400 ${isRTL ? 'text-right' : 'text-left'}`} role="alert">
                        {errors.name}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {errors.email && (
                      <p id="email-error" className={`mt-1 text-sm text-red-600 dark:text-red-400 ${isRTL ? 'text-right' : 'text-left'}`} role="alert">
                        {errors.email}
                      </p>
                    )}
                  </div>
                ...
                <div>
                  ...
                  {errors.inquiryType && (
                    <p id="inquiry-error" className={`mt-1 text-sm text-red-600 dark:text-red-400 ${isRTL ? 'text-right' : 'text-left'}`} role="alert">
                      {errors.inquiryType}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.message && (
                    <p id="message-error" className={`mt-1 text-sm text-red-600 dark:text-red-400 ${isRTL ? 'text-right' : 'text-left'}`} role="alert">
                      {errors.message}
                    </p>
                  )}
                </div>
                ...
                {submitStatus === 'success' && (
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4" role="alert">
                    <p className={`text-green-800 dark:text-green-200 ${isRTL ? 'text-right' : 'text-left'}`}>
                ...
                {submitStatus === 'error' && (
                  <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4" role="alert">
                    <p className={`text-red-800 dark:text-red-200 ${isRTL ? 'text-right' : 'text-left'}`}>
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-4' : 'space-x-4'}`}>
                  ...
                  <div className={isRTL ? 'text-right' : 'text-left'}>
                    ...
                    <a href="mailto:hello@movinware.com" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors" dir="ltr">
                      hello@movinware.com
                    </a>
                  </div>
                </div>
                ...
                <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-4' : 'space-x-4'}`}>
                  ...
                  <div className={isRTL ? 'text-right' : 'text-left'}>
                    ...
                    <a href="tel:+97144XXXXXX" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors" dir="ltr">
                      +971 4 XXX XXXX
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <motion.button 
                    className={`w-full bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center ${isRTL ? 'justify-center flex-row-reverse' : 'justify-center'} focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2`}
