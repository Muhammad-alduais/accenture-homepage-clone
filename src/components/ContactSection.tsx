          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <motion.div variants={itemVariants}>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  type="submit"
                  className="w-full bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-lg font-medium transition-colors text-lg"
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-4' : 'space-x-4'}`}>
                  ...
                  <div className={isRTL ? 'text-right' : 'text-left'}>
                    ...
                    <div className="text-gray-600 dark:text-gray-300" dir="ltr">hello@movinware.com</div>
                  </div>
                </div>
                ...
                <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-4' : 'space-x-4'}`}>
                  ...
                  <div className={isRTL ? 'text-right' : 'text-left'}>
                    ...
                    <div className="text-gray-600 dark:text-gray-300" dir="ltr">+971 4 XXX XXXX</div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <motion.button 
                    className={`w-full bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center ${isRTL ? 'justify-center flex-row-reverse' : 'justify-center'}`}
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                  ...
                  <motion.button 
                    className={`w-full border border-purple-600 text-purple-600 dark:text-purple-400 hover:bg-purple-600 hover:text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center ${isRTL ? 'justify-center flex-row-reverse' : 'justify-center'}`}
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <svg className={`w-5 h-5 ${isRTL ? 'ml-2' : 'mr-2'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
